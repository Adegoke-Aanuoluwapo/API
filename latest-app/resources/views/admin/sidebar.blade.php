<nav id="sidebar">
        ...
        <ul class="list-unstyled">
                <li class="active"><a href="admincss/index.html"> <i class="icon-home"></i>Home </a></li>
                ...
                <li><a href="{{url('show_post')}}"> <i class="icon-padnote"></i>Forms </a></li>
        ...
        <ul class="list-unstyled">
          <li> <a href="forms.html"> <i class="icon-settings"></i>Demo </a></li>
          <li> <a href="forms.html"> <i class="icon-writing-whiteboard"></i>Demo </a></li>
